...
namespace Web_App.Models
{
    public class PatientModel
    {
        ...
        [Required]
        [DisplayName("Intake By*")]
        public string IntakeByEntry { get; set; }

        public string UnderSupervisionByEntry { get; set; }

        [Required]
        [DisplayName("Head of Treatment*")]
        public string HeadOfTreatmentEntry { get; set; }
        ...
        [Required]
        [DisplayName("Has Resign Date*")]
        public bool HasResignDate { get; set; }
        ...
        public (Patient, PatientFile) Forge(ITherapistRepository therapistRepository, string profilePictureBase64)
        {
            ...
            patientFile.IntakeBy = therapistRepository.GetByName(IntakeByEntry).Item1;
            patientFile.IntakeById = patientFile.IntakeBy.Id;
            patientFile.HeadOfTreatment = therapistRepository.GetByName(HeadOfTreatmentEntry).Item1;
            patientFile.HeadOfTreatmentId = patientFile.HeadOfTreatment.Id;
            patientFile.UnderSupervisionBy = therapistRepository.GetByName(UnderSupervisionByEntry).Item1;
            patientFile.UnderSupervisionById = patientFile.UnderSupervisionBy?.Id;
            ...
            patientFile.Age = age;
            patientFile.RegisterDate = RegisterDate;
            patientFile.ResignDate = HasResignDate ? ResignDate : null;
            patientFile.GlobalDescription = GlobalDescription;
            patientFile.ExtraDescription = ExtraDescription;
            patientFile.DiagnoseCode = DiagnoseCode;

            patientDetails.PatientFile = patientFile;

            return (patientDetails, patientFile);
        }
    }
}